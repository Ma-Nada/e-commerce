...
if (isset($_POST['search'])) {
    ...
    // Handle the case when 'search' parameter is not provided
...
if (isset($_POST['chart'])) {
    ...
    if ($check_result && mysqli_num_rows($check_result) > 0) {
        // Product ID is valid, proceed with the insertion
        $query_insert = "INSERT INTO `command-line` (prod_id, comd_nbr) VALUES ('$prod_id', '1')";
        $query_run = mysqli_query($connection, $query_insert);

        if ($query_run) {
            // Query executed successfully, display success message or perform other actions
        ...
        // Invalid product ID, display error message
    ...
    while ($row = mysqli_fetch_assoc($check_result)) {
        ...
        <tbody class="align-middle">
            <tr>
                ...
                <td class="align-middle"><button type="submit" name="delete_btn" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td></form>
            </tr>
        <?php
    }
}
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3" onclick="window.location.href='login1.html';">Cash</button>

                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3" onclick="window.location.href='login1.html';">Credit Card</button>
                    </div>
                </div>
            </div>
        </div>
